...
public class FirstPersonDrivers {
    ...
    public static final DriverKey<VariableDriver<EntityType<?>>> LAST_USED_TARGET_ENTITY = DriverKey.of("last_used_target_entity", () -> VariableDriver.ofConstant(() -> EntityTypes.COW));
